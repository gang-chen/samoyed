...
const GtkActionEntry actionEntries[Samoyed::Actions::N_ACTIONS] =
{
    ...
    { "quit-session", GTK_STOCK_QUIT, N_("_Quit"), "<ctrl>Q",
      N_("Quit the current session"), G_CALLBACK(quitSession) },

    // Project menu.
    { "create-project", GTK_STOCK_NEW, N_("_New..."), NULL,
      N_("Create a project"), G_CALLBACK(createProject) },
    { "open-project", GTK_STOCK_OPEN, N_("_Open..."), NULL,
      N_("Open a project"), G_CALLBACK(openProject) },
    { "close-project", GTK_STOCK_CLOSE, N_("_Close"), NULL,
    ...
    { "create-file", GTK_STOCK_FILE, N_("New _File..."), NULL,
    ...
    { "save-file", GTK_STOCK_SAVE, N_("_Save"), "<ctrl>S",
    ...
    { "close-file", GTK_STOCK_CLOSE, N_("_Close"), NULL,
      N_("Close the current file"), G_CALLBACK(closeFile) },
    { "close-all-files", NULL, N_("C_lose All"), NULL,
    ...
    { "print-file", GTK_STOCK_PRINT, N_("_Print"), "<ctrl>P",
    ...
    { "cut", GTK_STOCK_CUT, N_("Cu_t"), "<ctrl>X",
      N_("Cut the selected object"), G_CALLBACK(cut) },
    { "copy", GTK_STOCK_COPY, N_("_Copy"), "<ctrl>C",
      N_("Copy the selected object"), G_CALLBACK(copy) },
    { "paste", GTK_STOCK_PASTE, N_("_Paste"), "<ctrl>V",
