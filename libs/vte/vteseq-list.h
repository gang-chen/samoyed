...
VTE_SEQUENCE_HANDLER(vte_sequence_handler_alternate_character_set_end)
VTE_SEQUENCE_HANDLER(vte_sequence_handler_alternate_character_set_start)
...
VTE_SEQUENCE_HANDLER(vte_sequence_handler_default_character_set)
...
VTE_SEQUENCE_HANDLER(vte_sequence_handler_utf_8_character_set)
